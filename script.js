...
class World {
    ...
    this.heartMaterial = new THREE.ShaderMaterial({
      ...
      uniforms: {
        ...
        uTex: {
          ...
          "https://cloudimg-lemon.vercel.app/1.png") } },
  ...
  loadMusic() {
    return new Promise(resolve => {
      ...
      audioLoader.load(
      "https://cloudimg-lemon.vercel.app/3.mp3",
      buffer => {
  ...
  addSnow() {
    this.snowMaterial = new THREE.ShaderMaterial({
      ...
      uniforms: {
        ...
        uTex: {
          value: new THREE.TextureLoader().load(
          "https://cloudimg-lemon.vercel.app/4.png") } },
